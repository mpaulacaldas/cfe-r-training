...
xaringanExtra::embed_xaringan(
  url = "https://mpaulacaldas.github.io/cfe-r-training/01_intro.html",
...
.footnote[
.small[
`r emoji("book")` [Chapter 27, R4DS](https://es.r4ds.hadley.nz/r-markdown.html#opciones-de-los-bloques)
]
]
...
__Romain Lesur__, the Head of Innovation at INSEE spoke on the [benefits and challenges of using RMarkdown in organisations](https://community.oecd.org/events/5062) at the OECD R/Python/Algobank CoP.
