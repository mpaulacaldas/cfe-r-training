...
1. Go to the [RStudio Cloud project](`r params$url_project`) and __TODO: Need input from Jolien for the steps__.
...
`r emoji("pencil")` .footnote[[Go to code](https://rstudio.cloud/project/2876071)]
