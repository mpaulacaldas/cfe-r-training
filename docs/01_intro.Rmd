...
---
# Demo: Preparing data for an OECD report
...
`r emoji("pencil")` Go to the [RStudio Cloud project](`r params$url_project`) and open the `demo.R` script to follow the code on how to prepare the data to make this figure.
---
class: exercise
