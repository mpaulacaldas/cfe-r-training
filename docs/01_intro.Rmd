...
params:
  module: "1"
  url_slides:  "https://mpaulacaldas.github.io/cfe-r-training/01_intro.html"
  url_project: "https://rstudio.cloud/project/2864232"
  url_demo: "https://rstudio.cloud/project/2876071"
...
Go to the [RStudio Cloud project](`r params$url_project`), open and follow the instructions in the `wrangle.R` script.
...
Go to the [RStudio Cloud project](`r params$url_project`), open and follow the instructions in the `join-and-bind.R` script.
